  ...
  render() {
    return (
      <div styleName="media">
        ...
        {this.props.media.type && this.props.media.type.startsWith("video") ? <div styleName="video"> <video autoPlay onEnded={this.props.removeMedia} src={this.props.media.url}/></div> : ""}
      </div>
    );
  }
}
